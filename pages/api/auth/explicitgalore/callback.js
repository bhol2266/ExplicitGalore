...
export default async function handler(req, res) {
  ...
  const redirectUri = "https://www.explicitgalore.com/api/auth/explicitgalore/callback"; // Make sure this matches your registered URI
  ...
  try {
    ...
    await fetch(`http://www.explicitgalore.com/api/auth/saveProfileFirestore`, {
      method: 'POST',
      headers: {
