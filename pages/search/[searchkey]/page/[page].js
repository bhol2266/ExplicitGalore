    ...
    return (
        <>
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(searchkey.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore | ${currentPageNumberURL}`}</title>
                ...
                <link rel="canonical" href={`https://www.ExplicitGalore.com/search/${searchkey}/page/${page}`} />
