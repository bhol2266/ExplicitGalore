    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore | ${currentPageNumberURL}`}</title>
                ...
                <meta name="keywords" content="porn, xxx, streaming porn, HD porn, HD adult videos, HD pussy videos, sex movies, ExplicitGalore" />
                <meta property="og:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore`} />
                ...
                <link rel="canonical" href={`https://www.ExplicitGalore.com/pornstar/${code}/${pornstarname}/page/${page}`} />
