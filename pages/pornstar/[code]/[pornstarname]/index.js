...
function Index({ video_collection, pages, pornstarInformation, collageImages }) {
    ...
    return (
        <>
              <Head>
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore`}</title>
                ...
                <link rel="canonical" href={`https://www.ExplicitGalore.com/pornstar/${code}/${pornstarname}`} />
            </Head>
