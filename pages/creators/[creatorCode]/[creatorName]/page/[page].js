        ...
        <>
            ...
            <Head>
                <title>{`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))
                    } Porn Videos - ExplicitGalore`}</title>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - ExplicitGalore`} />
                ...
                <link rel="canonical" href={`https://www.ExplicitGalore.com/channels/${creatorName}/${creatorCode}`} />
