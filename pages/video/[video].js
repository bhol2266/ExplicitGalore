    ...
    return (
        <div>
            ...
            {preloadedVideoQuality.length > 0 && !noVideo ? (
                <>
                    <Head>
                        <title>{`${noVideo ? videoTitleBackup : videoDetails.Title} - ${noVideo ? "720p" : videolinkQualitiesScreenshots.video_qualities_available[videolinkQualitiesScreenshots.video_qualities_available.length - 1].toUpperCase()}`} | ExplicitGalore</title>
                        <meta name="description" content={`Watch  ${capitalizeFirstLetter(noVideo ? videoTitleBackup : videoDetails.Title)} on ExplicitGalore `} />
                        ...
                        <meta property="og:description" content={`Watch  ${capitalizeFirstLetter(noVideo ? videoTitleBackup : videoDetails.Title)} on ExplicitGalore `} />
                        ...
                        <meta name="twitter:description" content={`Watch  ${capitalizeFirstLetter(noVideo ? videoTitleBackup : videoDetails.Title)} on ExplicitGalore `} />
                        <link rel="canonical" href={`https://www.ExplicitGalore.com/video/${video}`} />
                ...
                <>
                    <Head>
                        <title>{`${videoTitleBackup}`} | ExplicitGalore</title>
                        <meta name="description" content={`Watch ${capitalizeFirstLetter(videoTitleBackup)} on ExplicitGalore `} />
                        <meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />
                    </Head>
                    <div>
